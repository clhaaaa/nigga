...
namespace vtable_indexes
{
	...
	constexpr auto dms			= 20;
	constexpr auto extraBonePro	= 195;
	constexpr auto sceneEnd     = 9;
	constexpr auto setupBones	= 13;
	constexpr auto isPlayer     = 155;
	constexpr auto screenChange = 156;
	constexpr auto fireEvent	= 7;
}
...
public:
	...
	static bool	    __fastcall  DrawModelSetup(void* ECX, void* EDX, int* unk1, ModelRenderInfo_t &pInfo, DrawModelState_t *pState, matrix3x4_t** ppBoneToWorldOut);
...
private:
	...
	std::unique_ptr<VMTHook> pGameEvent;
	...
	typedef bool (__thiscall* DrawModelSetup_t) (void*, int*, ModelRenderInfo_t&, DrawModelState_t*, matrix3x4_t**);
